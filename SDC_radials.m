...
%                     'log-file=/var/log/EU_HFR_Node_SDC_dataset_builder/CDI.log trace=false max-files-in-zip=1000 UpdateCenter=on'];
                mikadoCommand = ['java -Dcom.sun.xml.bind.v2.bytecode.ClassTailor.noOptimize=true -cp ' ...
                    mikadoHome '/dist/*:dist/lib/* mikado.Mikado mikado-home=' mikadoHome '/ batch-type=XmlFiles '...
                    'batch-mode=CDI19139 conf-file=' confFile ' output-dir=' outputDir ' continue-when-error=false ' ...
                    'log-file=/var/log/EU_HFR_Node_SDC_dataset_builder/CDI.log trace=false max-files-in-zip=1000 UpdateCenter=on'];
