%% total_netCDF_aggregation_v211.m
...
function [tnA_err, ncFileNoPath, ncFilesize, tStart, tEnd, dataID] = total_netCDF_aggregation_v211(networkData,networkFields,stationData,stationFields,timeSpan)

disp(['[' datestr(now) '] - - ' 'total_netCDF_aggregation_v211.m started.']);
...
try
    ...
    if (~isempty(nc.time))
        ...
        disp(['[' datestr(now) '] - - ' 'total_netCDF_aggregation_v211.m successfully executed.']);
        tnA_err = 1;
        return
    end
catch err
